...
public class MainActivity extends AppCompatActivity {
    ...
    // Layout Views
    public static TextView vistaContador;
    public static TextView vistaMensaje;
    public static TextView vistaGForce;
    public static TextView vistaHPS;
    public static TextView vistaTBH;
    public static TextView vistaKcal;
    public static Chronometer vistaChrono;
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (mSection == 1) {
                ...
                vistaContador = (TextView)rootView.findViewById(R.id.contadorView);
                vistaMensaje = (TextView)rootView.findViewById(R.id.messageView);
                vistaGForce = (TextView)rootView.findViewById(R.id.gForceView);
                vistaHPS = (TextView)rootView.findViewById(R.id.hpsView);
                vistaTBH = (TextView)rootView.findViewById(R.id.tbhView);
                vistaKcal = (TextView)rootView.findViewById(R.id.kcalView);
                vistaChrono = (Chronometer)rootView.findViewById(R.id.chronometer);
                //TextView textView = (TextView) rootView.findViewById(R.id.vistaLargoTexto);
